...
EOD;
    ...
    function getEmailAndName($resourceOwner,$email_attr,$name_attr){
            ...
            if (isset($test_cookie) && !empty($test_cookie)) {
               ...
               echo '<span style="font-size:14pt;"><b>Hello</b>, </span><br/><p style="font-weight:bold;font-size:14pt;margin-left:1%;">ATTRIBUTES RECEIVED:</p>
                ...
                <div style="display:block;text-align:center;margin-bottom:4%;"><img style="width:15%;"src="' . $siteUrl . 'green_check.png"></div><br><code style="padding: 2px 4px;color: #d14;background-color: #f7f7f9;border: 1px solid #e1e1e8;font-weight:bolder;white-space: nowrap;">Next Step:</code>&emsp;<i>Please copy the <b>Attribute Name</b> in which you are getting <b>Email ID</b> and <b>Username</b>&ensp;<button style="padding:4px 4px 6px 4px;border-radius:2px;font-weight:bold;border: 1px solid rgba(0,0,0,0.2);color: #fff;background-color: #2384d3;cursor: pointer;" onClick="redirect_to_attribute_mapping();">Perform mapping</button><br><br></i></div>
              ';
               foreach ($resourceOwner as $key => $value)
                  echo "<tr><td style='font-weight:bold;border:2px solid #949090;padding:2%;'>" . $key . "</td><td style='padding:2%;border:2px solid #949090; word-wrap:break-word;'>" . implode('<br/>', (array)$value) . "</td></tr>";
                    ...
                    echo '<script>
                        ...
                        if(window.opener.location.href.includes("#performAttrMapping")===false){
                            window.opener.location.href = window.opener.location.href+"#performAttrMapping";
                        }
